...
class Snake(object):
    ...
    def move(self, action):
        if action == None:
            ...
            if self.dirnx == -1 and self.dirny == 0: # Left
                self.dirnx = 0
                self.dirny = 1
            elif self.dirnx == 0 and self.dirny == -1: # Up
                self.dirnx = -1
                self.dirny = 0
            elif self.dirnx == 1 and self.dirny == 0: # Right
                self.dirnx = 0
                self.dirny = -1
            elif self.dirnx == 0 and self.dirny == 1: # Down
                self.dirnx = 1
                self.dirny = 0
            self.turns[self.head.pos[:]] = [self.dirnx, self.dirny]
        elif action[1] == 1:
            if self.dirnx == 1 and self.dirny == 0: # Right
                self.dirnx = 0
                self.dirny = 1
            elif self.dirnx == 0 and self.dirny == -1: # Up
                self.dirnx = 1
                self.dirny = 0
            elif self.dirnx == -1 and self.dirny == 0: # Left
                self.dirnx = 0
                self.dirny = -1
            elif self.dirnx == 0 and self.dirny == 1: # Down
                self.dirnx = -1
